...
/*[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_SFTENT, KC_Z,    KC_X,    KC_C,    KC_V,       KC_B,     KC_N,     KC_M,       KC_COMM, KC_DOT,  KC_UP,   KC_SFTENT,
    KC_NO,   KC_LGUI, KC_LCTL, KC_LALT, MO(_LOWER),           KC_SPC,    MO(_RAISE), KC_SLSH,  KC_LEFT, KC_DOWN, KC_RGHT
),*/

[_QWERTY] = LAYOUT_planck_mit(
    KC_Q,  KC_Q,    KC_W,    KC_E,    KC_R,       KC_T,     KC_Y,     KC_U,       KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_A,  KC_A,    KC_S,    KC_D,    KC_F,       KC_G,     KC_H,     KC_J,       KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_Z, KC_Z,    KC_X,    KC_C,    KC_V,       KC_B,     KC_N,     KC_M,       KC_COMM, KC_DOT,  KC_UP,   KC_SFTENT,
    KC_Z,   KC_LGUI, KC_LCTL, KC_LALT, MO(_LOWER),           KC_SPC,    MO(_RAISE), KC_SLSH,  KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_mit(
    KC_A, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR,    KC_ASTR,    KC_LPRN, KC_RPRN, KC_TRNS,
    KC_B,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE,
    KC_C, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  KC_SFTENT,
    KC_D, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_MPLY,     KC_TRNS,    KC_MPRV,    KC_VOLD, KC_VOLU, KC_MNXT
),
